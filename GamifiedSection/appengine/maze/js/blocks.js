...
Blockly.Blocks['maze_turn'] = {
  ...
  init: function() {
    var DIRECTIONS =
        [[BlocklyGames.getMsg('Maze_turnNorth'), 'turnNorth'],
         [BlocklyGames.getMsg('Maze_turnNorthEast'), 'turnNorthEast'],
         [BlocklyGames.getMsg('Maze_turnEast'), 'turnEast'],
         [BlocklyGames.getMsg('Maze_turnSouthEast'), 'turnSouthEast'],
         [BlocklyGames.getMsg('Maze_turnSouth'), 'turnSouth'],
         [BlocklyGames.getMsg('Maze_turnSouthWest'), 'turnSouthWest'],
         [BlocklyGames.getMsg('Maze_turnWest'), 'turnWest'],
         [BlocklyGames.getMsg('Maze_turnNorthWest'), 'turnNorthWest']];
...
Blockly.Blocks['maze_if'] = {
  ...
  init: function() {
    ...
    var DIRECTIONS =
        [[BlocklyGames.getMsg('Maze_pathAhead'), 'isPathForward'],
         [BlocklyGames.getMsg('Maze_pathNorth'), 'isPathNorth'],
         [BlocklyGames.getMsg('Maze_pathNorthEast'), 'isPathNorthEast'],
         [BlocklyGames.getMsg('Maze_pathEast'), 'isPathEast'],
         [BlocklyGames.getMsg('Maze_pathSouthEast'), 'isPathSouthEast'],
         [BlocklyGames.getMsg('Maze_pathSouth'), 'isPathSouth'],
         [BlocklyGames.getMsg('Maze_pathSouthWest'), 'isPathSouthWest'],
         [BlocklyGames.getMsg('Maze_pathWest'), 'isPathWest'],
         [BlocklyGames.getMsg('Maze_pathNorthWest'), 'isPathNorthWest']];
