...
BlocklyGames.init = function() {
  ...
  //   }
  // }
  BlocklyGames.factor = (window.innerWidth) / 2133 > (window.innerHeight- document.getElementById('BClogo').offsetHeight)/ 1084 ? (window.innerHeight- document.getElementById('BClogo').offsetHeight)/ 1084 : window.innerWidth / 2133;
  // document.getElementById('brightChampsLogo').style.height = 45 * BlocklyGames.factor + 'px';
  ...
  var div = document.getElementById('coinanimation');
  // div.style.top = '0px';
  // div.style.left = document.getElementById('languageMenu').offsetLeft - 120 + 'px';
  BlocklyGames.coinanimate();
  setTimeout(function() {
...
BlocklyGames.coinval;
BlocklyGames.coinanimate = function () {
  // document.getElementById('coin').style.width = 45 * BlocklyGames.factor + 'px';
  // document.getElementById('coin').style.height = 45 * BlocklyGames.factor + 'px';
  // document.getElementById('coin').style.paddingTop = 5 * BlocklyGames.factor + 'px';
  // document.getElementById('BClogo').style.height = 45 * BlocklyGames.factor + 'px';
  // document.getElementById('brightChampsLogo').style.height = 45 * BlocklyGames.factor + 'px';
  var ctx = document.getElementById('coin').getContext('2d');
  var img = new Image();
  img.src = 'common/coin.png';
  var srcX;
  var srcY;
  ...
  function draw(){
    updateFrame();
    ctx.drawImage(img,srcX,srcY,width,Sheetheight1,0,0,45  ,45  );
  }
...
BlocklyGames.updatecoinvalue = function () {
  // document.getElementById('coinvalue').style.width = 45 * BlocklyGames.factor + 'px';
  // document.getElementById('coinvalue').style.height = 45 * BlocklyGames.factor + 'px';
  // document.getElementById('coinvalue').style.paddingTop = 5 * BlocklyGames.factor + 'px';
  var ctx = document.getElementById('coinvalue').getContext('2d');
  ctx.clearRect(0,0,80  ,45 );
  ctx.fillStyle = 'Black';
  ctx.font = 35  + 'px Arial';
  ctx.fillText(BlocklyGames.coinval, 0 , 35);
}
/**
